...
public:		
	...
	//-----------------------------------------------------------
	CIni(LPCTSTR lpPathName = NULL); //default construct + construct with a given file name
	virtual ~CIni();
	...
	//------------------------------------------------------------
	POINT GetPoint(LPCTSTR lpSection, LPCTSTR lpKey, const POINT &ptDefault) const;
	BOOL WritePoint(LPCTSTR lpSection, LPCTSTR lpKey, const POINT &pt) const;
	
	RECT GetRect(LPCTSTR lpSection, LPCTSTR lpKey, const RECT &rcDefault) const;
	BOOL WriteRect(LPCTSTR lpSection, LPCTSTR lpKey, const RECT &rc) const;
	...
	//------------------------------------------------------------
	void TransferInt(LPCTSTR lpSection, LPCTSTR lpKey, int &iValue, int iDefault, bool bSaveToFile);
	void TransferUInt(LPCTSTR lpSection, LPCTSTR lpKey, UINT &uValue, UINT uDefault, bool bSaveToFile);
	void TransferBool(LPCTSTR lpSection, LPCTSTR lpKey, bool &bValue, bool bDefault, bool bSaveToFile);
