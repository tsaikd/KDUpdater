...
public:
	...
	CString	GetHashString(BOOL bHex = FALSE, BOOL bURN = FALSE);
	CString	GetHashStringFromFile(LPCTSTR lpFilePath, BOOL bHex = FALSE, BOOL bURN = FALSE);
